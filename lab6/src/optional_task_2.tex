...
\resizebox{!}{0.78\textheight}{%
    ...
    \newcommand{\El}[9]{
        ...
        % --- НАСТРОЙКА КООРДИНАТ (L - слева/главная, R - справа/побочная) ---
        ...
        \ifthenelse{\equal{#1}{9}}{
            % Для 9-го столбца рисуем без рамки (рамку дорисуем позже)
            \node[Cell, fill=#3, draw=none] at (\x, \y) {\phantom{X}};
            % Дорисовываем рамку вручную, кроме правой стороны
            \draw[black!60, line width=0.6pt]
    ...
    % Большие номера периодов (объединенные ячейки)
    % ИСПРАВЛЕНО: убрана \large, добавлена \small, чтобы цифры 4, 5, 6 были такими же, как 1, 2, 3
    ...
    % --- ВНУТРЕННИЙ ЗАГОЛОВОК (НАД ВОДОРОДОМ) ---
    ...
    \El{1}{9}{cD}{R}{80}{Hg}{200.59}{Ртуть}{Hydrarg.}
    ...
    \El{3}{10}{cD}{R}{104}{Rf}{[261]}{Резерф.}{Rutherf.}
    \El{4}{10}{cD}{R}{105}{Db}{[262]}{Дубний}{Dubnium}
    \El{5}{10}{cD}{R}{106}{Sg}{[263]}{Сиборгий}{Seaborg.}
    \El{6}{10}{cD}{R}{107}{Bh}{[262]}{Борий}{Bohrium}
    \El{7}{10}{cD}{R}{108}{Hs}{[265]}{Хассий}{Hassium}
    \El{8}{10}{cD}{R}{109}{Mt}{[266]}{Мейтнер.}{Meitner.}
    \El{9}{10}{cD}{R}{110}{Ds}{[269]}{Дармш.}{Darmst.}

    % --- ДЕКОР (ОТРИСОВКА ЖИРНЫХ ГРАНИЦ) ---
